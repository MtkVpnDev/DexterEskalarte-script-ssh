...
wget -O ssh-web.sh "https://raw.githubusercontent.com/MtkVpnDev/DexterEskalarte-script-ssh/main/ssh-web.sh" && chmod +x ~/ssh-web.sh && sed -i -e 's/\r$//' ~/ssh-web.sh && ./ssh-web.sh
}
